        ...
        <div class="col-md-12">
            ...
            <div class="card col s12 m6">
                        ...
                        <div class="card-content" style="margin-bottom:50px;">
                          ...
                          <p><a href="{{ URL::route('organizations.donates.create', $organization->id) }}" class="waves-effect waves-light btn right" style="background-color:#ee6e73; margin-top:10px;">Participate</a></p>
                        </div>
